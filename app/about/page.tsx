...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "VyomikX is a student-led movement at ZHCET, AMU sharing tools, mentorship, and equipment so every curious student can build with technology — for free.",
}
...
const journey = [
  ...
  },
  {
    ...
    text: "With over 100+ students mentored and school visits actively running, we are building toward an open campus maker space for every curious mind.",
  },
]
            ...
            {journey.map((item, i) => (
              <li key={item.title} className="relative flex gap-6">
                <div className="flex flex-col items-center">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-accent/30 bg-accent/10 font-display text-sm font-bold text-accent">
                    {item.year}
                  </div>
